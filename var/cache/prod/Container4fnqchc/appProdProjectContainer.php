...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory(array())) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'labo', 'user' => 'root', 'password' => '', 'charset' => 'UTF8', 'driverOptions' => array(1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'), 'serverVersion' => 5.1, 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array('enum' => 'string'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_ee6c0d4a12765c10b6852ab88eb87e9734ae9b5ec2226bcfeca6b2b8e3dd99ea');
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('7NnSRm6SkdqkJyZhraBJ60pXjkSfy0GAp98t3qYt1vLfneqnQgKE0VUB')) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('7NnSRm6SkdqkJyZhraBJ60pXjkSfy0GAp98t3qYt1vLfneqnQgKE0VUB');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '7NnSRm6SkdqkJyZhraBJ60pXjkSfy0GAp98t3qYt1vLfneqnQgKE0VUB',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2018-11-19',
            'locale' => 'en-US',
            'cookie_key' => 'ga4wqRkt4fEtYFJm5SaBnsxRvR9hhE6MVgND2YmTc47ws8JMaC925Sfo',
            'cookie_iv' => 'aDCv2d7w',
            'new_cookie_key' => 'def000002b64311d0eae86cb1e096d164d3ed4dc28cd7b5e7ea336262bb8385cc310ddff416586614a305a4485f9be7e7adf80a1c467fa5615ad0415fabfbd348c5ea891',
            'cache.driver' => 'array',
            ...
            'kernel.secret' => '7NnSRm6SkdqkJyZhraBJ60pXjkSfy0GAp98t3qYt1vLfneqnQgKE0VUB',
